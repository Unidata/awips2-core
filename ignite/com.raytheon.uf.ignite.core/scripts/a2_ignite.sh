...
# Add Ignite recommended JVM arguments for Java 17
# These options provide access to private APIs and are currently needed 
# for Ignite to run on Java 17, but could change in future releases.
# See: https://ignite.apache.org/docs/latest/quick-start/java#running-ignite-with-java-11-or-later
JVM_OPTS+=" --add-opens=java.base/jdk.internal.access=ALL-UNNAMED \
