...
#
# Compressed, Chunked version of a DataRecord.
#
#
#     SOFTWARE HISTORY
#
...
class CompressedChunkedDataRecord(object):
    ...
    def getChunkIndices(self):
        return self.chunkIndices

    def setChunkIndices(self, chunkIndices):
        self.chunkIndices = chunkIndices


    def setCompressedChunks(self, compressedChunks):
        self.compressedChunks = compressedChunks
        
    def getCompressedChunks(self):
        return self.compressedChunks
    ...
    def putDataObject(self, obj):
        self.compressedChunks = obj
    
    def determineStorageTypeNonChunked(self):
        if self.type == "BYTE":
            return numpy.byte
