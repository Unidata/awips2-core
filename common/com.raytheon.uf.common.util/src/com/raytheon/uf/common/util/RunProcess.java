 ...
 * terminates. Intended use is for a process generated by the command:
 * <li>Runtime.getRuntime().exec(...)</li>
 * <li><b>instead do:</b></li>
 * <li>RunProcess.getRunProcess().exec(...);</li>
 * <li><b>or</b></li>
 * <li>RunProcess.getRunProcess.setProcess(ProcessBuilder.start())</li>
 *
 * <pre>
 *
 * SOFTWARE HISTORY
 ...
 * Jan 26, 2017  6092     randerso  Added waitFor with timeout and stop methods.
 *
 * </pre>
 *
 * @author rferrel
...
public class RunProcess {
     ...
     *
     * @return a new RunProcess instance
     */
    ...
    private static void read(StringBuilder sb, InputStream stream) {
     ...
     * @throws IOException
     */
    public RunProcess exec(String[] cmdarray, String[] envp)
            throws IOException {
     ...
     *
     * @return exitValue or INTERRUPTED when interrupted
    ...
    /**
     * Wait for the process to finish or a specified amount of time has elapsed.
     *
     * @param timeout
