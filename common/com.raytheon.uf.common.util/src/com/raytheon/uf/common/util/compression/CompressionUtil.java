 ...
 **/
package com.raytheon.uf.common.util.compression;
 ...
 * Aug 30, 2017 6398       tgurney     Move from Collaboration to uf.common.util
 *
 * </pre>
 *
 * @author njensen
...
public class CompressionUtil {
    ...
    public static final CompressionType COMPRESSION_TYPE = CompressionType.ZLIB;

    private static final boolean log_compression = false;
    ...
    public static byte[] uncompress(byte[] bytes) throws IOException {
        ...
        long start = System.currentTimeMillis();
        try (ReadableByteChannel src = Channels
