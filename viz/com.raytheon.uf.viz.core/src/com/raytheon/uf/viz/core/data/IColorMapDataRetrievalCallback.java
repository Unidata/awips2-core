 ...
 * Mar 21, 2013  1806     bsteffen  Add ColorMapData constructor that creates
 *                                  buffer from the dataType.
...
public interface IColorMapDataRetrievalCallback {
    ...
    /**
     * Returns whether or not this data should be restaged if removed from the
     * graphics card memory due to space limitations.
     *
     * @return
     */
    public default boolean isRestagingEnabled() {
        return true;
    }
