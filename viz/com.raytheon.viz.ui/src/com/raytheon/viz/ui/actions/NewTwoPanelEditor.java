 ...
 * ------------ ---------- ----------- --------------------------
 * Apr 20, 2016            mjames@ucar Copied from NewFourPanelEditor
 * 
 * </pre>
 * 
 * @author mschenke
...
public class NewTwoPanelEditor extends AbstractHandler {
    private static final transient IUFStatusHandler statusHandler = UFStatus
            .getHandler(NewTwoPanelEditor.class);

    private static int NUM_PANELS = 2;
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        if (part != null) {
            ...
            if (panes != null && panes.length < NUM_PANELS) {
                ...
                for (int i = panes.length; i < NUM_PANELS; ++i) {
                    mpe.addPane(displayToClone.createNewDisplay());
                }
            }
        } else {
            statusHandler.handle(Priority.PROBLEM,
                    "Could not open new two panel editor", new VizException());
        }
        return part;
    }
