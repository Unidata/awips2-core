 ...
 * that ensures the {@link FloatingWindowAddon} is present in the application
 * model.
 * 
 * <pre>
 *
 ...
 * @author bsteffen
 */
public class FloatingWindowProcessor {
    ...
    void addFloatingWindowAddon(MApplication app, EModelService modelService) {
        ...
        for (MAddon addon : addons) {
             ...
             */
            if (addon.getContributionURI().contains("FloatingWindowAddon")) {
                return;
            }
        }
        ...
        addon.setElementId("FloatingWindowAddon");
        addon.setContributionURI("bundleclass://" + UiPlugin.PLUGIN_ID + "/"
                + FloatingWindowAddon.class.getName());
        addons.add(addon);
    }
}
