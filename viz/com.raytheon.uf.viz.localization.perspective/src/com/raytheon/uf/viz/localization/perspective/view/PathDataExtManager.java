 ...
 * May 26, 2016 4907       mapeters    Updated PATH_DEFINITION_ID
 * 
 * </pre>
 * 
 * @author mschenke
...
public class PathDataExtManager {
    ...
    private static final String PATH_DEFINITION_ID = "com.raytheon.uf.viz.localization.perspective.localizationpath";
                    ...
                    if (typesString == null) {
                        ...
                        statusHandler.handle(
                                ...
                                "Skipping path extension entry with name: "
                                        + pd.getName() + " and path: "
                                        + pd.getPath()
                                        + " with invalid localization type: "
