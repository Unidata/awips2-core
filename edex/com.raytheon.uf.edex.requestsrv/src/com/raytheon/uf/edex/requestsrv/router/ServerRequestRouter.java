...
/**
 * Routes the request directly to the {@link RequestServiceExecutor} bypassing
 * authorization/authentication by wrapping priviledged requests
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
...
public class ServerRequestRouter implements IRequestRouter {
    ...
    public Object route(IServerRequest request) throws Exception {
        ...
        return RequestServiceExecutor.getInstance().execute(request);
    }
