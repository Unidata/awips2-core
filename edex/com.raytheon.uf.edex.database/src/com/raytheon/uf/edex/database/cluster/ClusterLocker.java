...
public class ClusterLocker {
    protected static final transient IUFStatusHandler handler = UFStatus
            .getHandler(ClusterLocker.class);

    public CoreDao dao;

    public ClusterLocker(String database) {
        dao = new CoreDao(DaoConfig.forDatabase(database));
    }
     ...
     * @return
     */
    public ClusterTask lock(String taskName, String details,
     ...
     * @return
     */
    public boolean updateLockTime(String taskName, String details,
            long updateTime) {
        Session s = null;
        Transaction tx = null;
        ClusterTask ct = null;
     ...
     *         failed
     */
    public boolean updateExtraInfo(String taskName, String details,
            String extraInfo) {
        Session s = null;
        Transaction tx = null;
        ClusterTask ct = null;
     ...
     *         failed
     */
    public boolean updateExtraInfoAndLockTime(String taskName,
     ...
     * @return
     */
    public ClusterTask lookupLock(String taskName, String details) {
        Session s = null;
        Transaction tx = null;
        ClusterTask ct = null;
        LockState ls = LockState.SUCCESSFUL;
     ...
     * @return
     */
    public boolean unlock(ClusterTask ct, boolean clearTime) {
        Session s = null;
        Transaction tx = null;
        boolean rval = true;
     ...
     * @return
     */
    public boolean unlock(String taskName, String details) {
        Session s = null;
        Transaction tx = null;
        boolean rval = true;
     ...
     * @return
     */
    public boolean deleteLock(String taskName, String details) {
        Session s = null;
        Transaction tx = null;
        boolean rval = true;
        ClusterTaskPK pk = new ClusterTaskPK();
    ...
    public List<ClusterTask> getLocks(String name) {
